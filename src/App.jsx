                ...
                <div className="bg-white rounded-xl shadow-md border border-slate-200 p-3.5 sm:p-8 space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 items-center">
                    <p className="text-xs sm:text-sm text-slate-600 leading-relaxed text-justify">
                      {lang === 'hi'? 'भारत सरकार द्वारा शुरू की गई PM सूर्य घर: मुफ्त बिजली योजना देश के 1 करोड़ से अधिक परिवारों को स्वच्छ, पर्यावरण-अनुकूल और किफायती सौर ऊर्जा से जोड़ने का एक दूरदर्शी और महत्वाकांक्षी राष्ट्रीय अभियान है। इस योजना का प्राथमिक उद्देश्य मध्यम और निम्न-मध्यम आय वर्ग वाले परिवारों के मासिक बिजली बिलों के भारी-भरकम वित्तीय बोझ को खत्म करके उन्हें ऊर्जा के क्षेत्र में पूरी तरह आत्मनिर्भर बनाना है। इसके तहत उत्तर प्रदेश के पात्र लाभार्थियों को अपने छतों (Rooftops) पर सोलर पैनल स्थापित करने के लिए केंद्र और राज्य सरकार द्वारा मिलाकर अधिकतम ₹1,08,000 तक की कुल डीबीटी (Direct Benefit Transfer) सब्सिडी प्रदान की जाती है। इतना ही नहीं, अतिरिक्त लागत को आसान बनाने के लिए बैंकों के माध्यम से बहुत कम ब्याज दर पर बिना किसी जटिल गारंटी के लोन (Collateral-Free Financing) की सुविधा भी उपलब्ध कराई जाती है। यह योजना न केवल आम नागरिकों को हर महीने 300 यूनिट तक मुफ्त बिजली का लाभ देती है, बल्कि नेट-मीटरिंग तकनीक के माध्यम से अतिरिक्त उत्पादित बिजली को DISCOM को बेचकर अतिरिक्त आय कमाने का शानदार अवसर भी प्रदान करती है।'
                      : 'Launched by the Government of India, the PM Surya Ghar: Muft Bijli Yojana is a visionary national campaign aimed at connecting over 1 crore households with clean, eco-friendly, and affordable solar energy. The primary objective of this scheme is to completely free middle and lower-middle-class families from heavy monthly electricity bills and make them self-reliant in energy. Under this scheme, eligible beneficiaries in Uttar Pradesh receive a total DBT (Direct Benefit Transfer) subsidy of up to ₹1,08,000 (combining Central and State subsidies) for installing rooftop solar panels. Furthermore, low-interest collateral-free bank loans are available to cover remaining costs. The scheme offers up to 300 units of free electricity monthly and allows households to earn extra income by selling surplus power back to DISCOM via net-metering.'}
                     </p>
                    <img
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 items-center pt-1 sm:pt-4">
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 leading-relaxed text-justify order-1 md:order-2">
                      {lang === 'hi'
                        ? 'नवीन एवं नवीकरणीय ऊर्जा मंत्रालय (MNRE) और राज्य सरकार द्वारा संचालित इस योजना के अंतर्गत पारदर्शी और त्वरित वित्तीय सहायता (सब्सिडी) की पूरी राशि बिना किसी बिचौलिए के सीधे लाभार्थी के आधार-लिंक्ड बैंक खाते में हस्तांतरित (DBT) की जाती है। इस मानक संरचना के तहत, 1 किलोवाट (kW) क्षमता वाले आवासीय सोलर सिस्टम पर ₹45,000 (₹30,000 केंद्र + ₹15,000 UP राज्य) की वित्तीय सहायता दी जाती है। वहीं 2 किलोवाट (kW) क्षमता के सिस्टम के लिए ₹90,000 (₹60,000 केंद्र + ₹30,000 UP राज्य) की सब्सिडी निर्धारित की गई है। 3 किलोवाट (kW) या उससे अधिक क्षमता के बड़े सोलर प्लांट लगाने पर लाभार्थियों को अधिकतम ₹1,08,000 (₹78,000 केंद्र + ₹30,000 UP राज्य) की कुल सब्सिडी का लाभ मिलता है। यह सब्सिडी प्रक्रिया पूरी तरह डिजिटल है, जिससे आवेदकों को आवेदन की स्थिति, डीआईएसकॉम (DISCOM) अप्रूवल और बैंक खाते में फंड ट्रांसफर की हर जानकारी ऑनलाइन पोर्टल पर पारदर्शी तरीके से प्राप्त होती है।'
                      : 'Managed by the Ministry of New and Renewable Energy (MNRE) alongside the state government, this scheme ensures full subsidy amounts are transferred directly to beneficiaries\' Aadhar-linked bank accounts via DBT without intermediaries. Under this structured model, a 1 kW residential solar system receives a total subsidy of ₹45,000 (₹30,000 Central + ₹15,000 UP State). A 2 kW system is eligible for ₹90,000 (₹60,000 Central + ₹30,000 UP State). For systems of 3 kW or higher capacity, beneficiaries receive the maximum total subsidy of ₹1,08,000 (₹78,000 Central + ₹30,000 UP State). The entire process is digitally managed, allowing applicants to transparently track application status, DISCOM approvals, and fund transfers online.'}
                  </p>
                  </div>
                </div>
